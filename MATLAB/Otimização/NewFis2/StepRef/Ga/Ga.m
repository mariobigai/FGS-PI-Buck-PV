...
%inicia a matriz de melhores individuos --------------------------------------------------------
    ...
    population3 = parameters.Restr(5) +(parameters.Restr(6)-parameters.Restr(5))*rand(parameters.populationSize-1, 16);
    population4 = parameters.Restr(7) +(parameters.Restr(8)-parameters.Restr(7))*rand(parameters.populationSize-1,50);
    population5 = parameters.Restr(9) +(parameters.Restr(10)-parameters.Restr(9))*rand(parameters.populationSize-1,25);
...
%Looping principal --------------------------------------------------------
    for i=1:parameters.maxGenerations
        ...
        close_system('buck_pv_otm_step_vref2', 0);
        Simulink.sdi.clear;
...
%Salva resultados parciais e limpa a memória a cada 5 gerações --------------------------------------------------------   
        if mod(i,5)==0
            ...
            fprintf(fid,'\n -----------------------------------------------------\n');
            %fprintf(fid,'O melhor valor encontrado foi %f na posição [%f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f]\n',best_fitness,best_subject);
